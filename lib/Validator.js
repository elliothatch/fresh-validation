...
Validator.prototype.whitelist = function() {
	whitelistProperties(this.internalTarget, this.validatedProperties);
};
...
// TODO: add support for an "exception object" that doesn't delete properties on selections
// (e.g. {a: {b: true}}, b can have any properties on it
ValidationChain.prototype.whitelist = function() {
	whitelistProperties(this.validator.internalTarget, this.validatedProperties);
	return this;
};
...
function whitelistProperties(o, keyObj) {
	if(typeof o !== 'object' || o === null) {
		return o;
	}
	...
	for(var p in o) {
		if(keyObj.hasOwnProperty(p)) {
			whitelistProperties(o[p], keyObj[p]);
		}
		else {
			delete o[p];
		}
